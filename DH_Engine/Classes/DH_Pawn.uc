...
// Overridden to prevent resupply of parachute/staticline and dropped AT weapons - PsYcH0_Ch!cKeN
function bool DHResupplyExplosiveWeapons(bool bHasEnemyNade, bool bHasEnemySmokeNade)
{
	local int i;
	local string S, ItemString;
	local DHPlayer P;
	local RORoleInfo RI;
