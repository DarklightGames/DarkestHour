...
defaultproperties
{
    ...
    OfficialMaps(36)="DH-Lutremange_Armoured.rom"
    OfficialMaps(37)="DH-Makhnovo_Advance.rom"
    OfficialMaps(38)="DH-Noville.rom"
    OfficialMaps(39)="DH-Nuenen_Advance.rom"
    OfficialMaps(40)="DH-Oosterbeek_Advance.rom"
    OfficialMaps(41)="DH-Pariserplatz.rom"
    OfficialMaps(42)="DH-Poteau_Ambush.rom"
    OfficialMaps(43)="DH-Putot-en-Bessin_Advance.rom"
    OfficialMaps(44)="DH-Raids.rom"
    OfficialMaps(45)="DH-Rakowice.rom"
    OfficialMaps(46)="DH-Reichswald.rom"
    OfficialMaps(47)="DH-Simonskall.rom"
    OfficialMaps(48)="DH-Stavelot.rom"
    OfficialMaps(49)="DH-St-Clement.rom"
    OfficialMaps(50)="DH-Stoumont.rom"
    OfficialMaps(51)="DH-Stoumont_Advance.rom"
    OfficialMaps(52)="DH-Targnon.rom"
    OfficialMaps(53)="DH-Varaville_Advance.rom"
    OfficialMaps(54)="DH-Vierville.rom"
    OfficialMaps(55)="DH-Vieux.rom"
    OfficialMaps(56)="DH-Vossenack_November7th.rom"
    OfficialMaps(57)="DH-Watrange.rom"
