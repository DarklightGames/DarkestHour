...
var protected string WorkInProgressMaps[29];            // this one also
...
defaultproperties
{
    ...
    OfficialMaps(30)="DH-La_Gleize_Advance.rom"
    OfficialMaps(31)="DH-La_Gleize_Push.rom"
    OfficialMaps(32)="DH-Lutremange_Clash.rom"
    OfficialMaps(33)="DH-Lutremange_Push.rom"
    OfficialMaps(34)="DH-Noville_Advance.rom"
    OfficialMaps(35)="DH-Noville_Push.rom"
    OfficialMaps(36)="DH-Nuenen_Clash.rom"
    OfficialMaps(37)="DH-Oosterbeek_Advance.rom"
    OfficialMaps(38)="DH-Pariserplatz_Push.rom"
    OfficialMaps(39)="DH-Poteau_Ambush_Push.rom"
    OfficialMaps(40)="DH-Putot-en-Bessin_Advance.rom"
    OfficialMaps(41)="DH-Radar_Advance.rom"
    OfficialMaps(42)="DH-Raids_Push.rom"
    OfficialMaps(43)="DH-Rakowice_Push.rom"
    OfficialMaps(44)="DH-Reichswald_Push.rom"
	...
	WorkInProgressMaps(4)="DH-WIP_BridgeAssault_Cutoff.rom"
	WorkInProgressMaps(5)="DH-WIP_Butovo_Advance.rom"
	WorkInProgressMaps(6)="DH-WIP_Chambois_Push.rom"
	WorkInProgressMaps(7)="DH-WIP_Champs_Advance.rom"
	WorkInProgressMaps(8)="DH-WIP_Cholm_Advance.rom"
	WorkInProgressMaps(9)="DH-WIP_Danzig_Push.rom"
	WorkInProgressMaps(10)="DH-WIP_Dom-Pavlova_Advance.rom"
	WorkInProgressMaps(11)="DH-WIP_Kasserine_Pass_Advance.rom"
	WorkInProgressMaps(12)="DH-WIP_Leningrad_Push.rom"
	WorkInProgressMaps(13)="DH-WIP_Leszinow_Advance.rom"
	WorkInProgressMaps(14)="DH-WIP_Maupertus_Push.rom"
	WorkInProgressMaps(15)="DH-WIP_Odessa_Push.rom"
	WorkInProgressMaps(16)="DH-WIP_Ogledow_Clash.rom"
	WorkInProgressMaps(17)="DH-WIP_Pegasus_Bridge_Advance.rom"
	WorkInProgressMaps(18)="DH-WIP_Pointe_Du_Hoc_Push.rom"
	WorkInProgressMaps(19)="DH-WIP_Port-En-Bessin_Push.rom"
	...
	WorkInProgressMaps(24)="DH-WIP_San_Valentino_Advance.rom"
	WorkInProgressMaps(25)="DH-WIP_Schijndel_Advance.rom"
	WorkInProgressMaps(26)="DH-WIP_Smolensk_Stalemate.rom"
	WorkInProgressMaps(27)="DH-WIP_Turqueville_Push.rom"
	WorkInProgressMaps(28)="DH-WIP_Winter_Stalemate_Clash.rom"
}
