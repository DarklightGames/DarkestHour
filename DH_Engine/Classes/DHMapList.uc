...
defaultproperties
{
    ...
    OfficialMaps(30)="DH-La_Cambe.rom"
    ...
    OfficialMaps(36)="DH-Makhnovo_Advance.rom"
    OfficialMaps(37)="DH-Noville.rom"
    OfficialMaps(38)="DH-Nuenen_Advance.rom"
    OfficialMaps(39)="DH-Oosterbeek_Advance.rom"
    OfficialMaps(40)="DH-Pariserplatz.rom"
    OfficialMaps(41)="DH-Poteau_Ambush.rom"
    OfficialMaps(42)="DH-Putot-en-Bessin_Advance.rom"
    OfficialMaps(43)="DH-Raids.rom"
    OfficialMaps(44)="DH-Rakowice.rom"
    OfficialMaps(45)="DH-Reichswald.rom"
    OfficialMaps(46)="DH-Simonskall.rom"
    OfficialMaps(47)="DH-Stavelot.rom"
    OfficialMaps(48)="DH-St-Clement.rom"
    OfficialMaps(49)="DH-Stoumont.rom"
    OfficialMaps(50)="DH-Stoumont_Advance.rom"
    OfficialMaps(51)="DH-Targnon.rom"
    OfficialMaps(52)="DH-Varaville_Advance.rom"
    OfficialMaps(53)="DH-Vierville.rom"
    OfficialMaps(54)="DH-Vieux.rom"
    OfficialMaps(55)="DH-Vossenack_November7th.rom"
