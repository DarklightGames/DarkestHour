...
defaultproperties
{
    ...
    OfficialMaps(7)="DH-Dead_Man's_Corner.rom"
    OfficialMaps(8)="DH-Dog_Green.rom"
    OfficialMaps(9)="DH-Freyneux_and_Lamormenil.rom"
    OfficialMaps(10)="DH-Foucarville.rom"
    OfficialMaps(11)="DH-Foy.rom"
