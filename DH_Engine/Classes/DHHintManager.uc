...
defaultproperties
{
    ...
    Hints(14)=(Title="Deploy Vehicle",Text="You are driving a deploy vehicle! When this vehicle's engine is off, your team can use it as a spawn point! Remember to turn off the engine (%FIRE%) before you leave!")
    Hints(15)=(Title="Deploy Vehicle",Text="Your team can only spawn on this deploy vehicle when the engine is off and there are no enemies nearby!")
    Hints(16)=(Title="Deploy Vehicle",Text="Deploy vehicles can be critical in the outcome of any battle! Treat them with care! If you need to leave the vehicle, be sure to leave it in a safe area!")
    Hints(17)=(Title="Deploy Vehicle",Text="You have left a deploy vehicle with the engine running! Your team will not be able to spawn on it unless it's engine is off!")
