...
defaultproperties
{
    ...
    Hints(15)=(Title="Deployment Vehicle",Text="Your team can only spawn on this deployment vehicle when the engine is off! Remember to turn off the engine (%FIRE%) before you leave!")
    ...
    Hints(17)=(Title="Deployment Vehicle",Text="You have left a deployment vehicle with the engine running! Your team will not be able to spawn on it unless it's engine is off!")
