...
defaultproperties
{
    ...
    Hints(50)=(Title="Artillery Operators",Text="Open map to coordinate fire. Use [RIGHTMOUSE] on a fire support request to select it as the active target or use the Ruler marker to measure distances to a given spot on the map.")
