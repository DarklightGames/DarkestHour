...
defaultproperties
{
    ...
    Options(2)=(ActionText="Detach Weapon",Material=Texture'DH_InterfaceArt2_tex.DetachMG',HoldTime=2.5,HoldSound=Sound'DH_MortarSounds.mortar_pickup')
    Options(3)=(ActionText="Attach Weapon",Material=Texture'DH_InterfaceArt2_tex.AttachMG',HoldTime=2.5,HoldSound=Sound'DH_MortarSounds.mortar_pickup')
