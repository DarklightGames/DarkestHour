...
defaultproperties
{
    ...
    PeriscopeOverlay=Texture'DH_VehicleOptics_tex.German.Sf14z_periscope' // SF14Z stereo binocular periscope with 10x magnification
                                                                          // But have to fudge to approx 8x magnification (ViewFOV=10.67) as for some reason shell tracers aren't visible if FOV is lower
