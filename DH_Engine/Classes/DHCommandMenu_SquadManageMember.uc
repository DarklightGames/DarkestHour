...
defaultproperties
{
    ...
    Options(3)=(SubjectText="Make assistant",Material=Texture'DH_InterfaceArt_tex.Communication.need_assist_icon')
    Options(4)=(SubjectText="Remove assistant",Material=Texture'DH_InterfaceArt_tex.Communication.need_assist_icon')
}
