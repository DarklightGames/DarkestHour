...
defaultproperties
{
    ...
    Records(128)=(ClassName="DH_Guns.DH_M1919A4_M2_Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("m1919a4", "m1919a4"))
    Records(129)=(ClassName="DH_Guns.DH_M1919A4_M1917_Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("m1917"))
    Records(130)=(ClassName="DH_Guns.DH_Fiat35Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat35"))
    Records(131)=(ClassName="DH_Guns.DH_Fiat14Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat14"))
