...
defaultproperties
{
    ...
    Records(124)=(ClassName="DH_Guns.DH_M1919A4Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("m1919a4"))
    Records(125)=(ClassName="DH_Guns.DH_Fiat1435ACWeapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat1435"))
    Records(126)=(ClassName="DH_Guns.DH_Fiat1435WCWeapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat1435w"))
}
