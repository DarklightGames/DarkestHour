...
defaultproperties
{
    ...
    Records(128)=(ClassName="DH_Guns.DH_M1919A4Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("m1919a4"))
    Records(129)=(ClassName="DH_Guns.DH_Fiat35Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat1435"))
    Records(130)=(ClassName="DH_Guns.DH_Fiat14Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat1435w"))
    ...
    Records(133)=(ClassName="DH_Guns.DH_MG42LafetteWeapon",bShouldExcludeFromGiveAll=true,WeaponNames=("mg42lafette"))
}
