...
defaultproperties
{
    ...
    Records(129)=(ClassName="DH_Guns.DH_Fiat35Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat35"))
    Records(130)=(ClassName="DH_Guns.DH_Fiat14Weapon",bShouldExcludeFromGiveAll=true,WeaponNames=("fiat14"))
