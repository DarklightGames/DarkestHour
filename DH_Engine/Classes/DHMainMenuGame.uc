...
const LIMITER_ITERATIONS =              1000;                   // Base number of iterations the limiter will do, it increases dynamically with InterationMultiplier
...
event Tick(float DeltaTime)
{
    ...
    {
        for (i = 0; i < (LIMITER_ITERATIONS * InterationMultiplier); ++i)
        {
