...
defaultproperties
{
    ...
    MapInfos(28)=(Name="DH-Lutremange_Clash",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Large)
    MapInfos(29)=(Name="DH-Lutremange_Push",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_Large)
    ...
    MapInfos(164)=(Name="DH-Brémoy_Advance",AlliedNation=NATION_Britain,GameType=GAMETYPE_Advance,Size=SIZE_Medium)
}
