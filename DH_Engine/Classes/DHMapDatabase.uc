...
defaultproperties
{
    ...
    MapInfos(42)=(Name="DH-Raids_Push.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_Medium)
    ...
    MapInfos(70)=(Name="DH-Maupertus_Push.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_Small)
    ...
    MapInfos(79)=(Name="DH-Riga_Docks_Push.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_ExtraSmall)
    ...
    MapInfos(83)=(Name="DH-Schijndel_Advance.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Advance,Size=SIZE_Large)
    ...
    MapInfos(86)=(Name="DH-TulaOutskirts_Push.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_Small)
    MapInfos(87)=(Name="DH-Winter_Stalemate_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Medium)
    ...
    MapInfos(113)=(Name="DH-Red_God_Of_War_Push.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Push,Size=SIZE_Large)
    ...
    MapInfos(122)=(Name="DH-Armored_Arad_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(123)=(Name="DH-Armored_Balaton_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(124)=(Name="DH-Armored_Bautzen_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(125)=(Name="DH-Armored_Black_Day_July_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(126)=(Name="DH-Armored_Brenus_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(127)=(Name="DH-Armored_Cagny_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(128)=(Name="DH-Armored_Celles_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(129)=(Name="DH-Armored_Debrecen_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(130)=(Name="DH-Armored_Eindhoven_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(131)=(Name="DH-Armored_Freyneux_Advance.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Advance,Size=SIZE_Any)
    MapInfos(132)=(Name="DH-Armored_Fruhlingserwachen_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    ...
    MapInfos(135)=(Name="DH-Armored_Hunters_Woods_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    ...
    MapInfos(139)=(Name="DH-Armored_KrivoiRog_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    ...
    MapInfos(143)=(Name="DH-Armored_Lemberg_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(144)=(Name="DH-Armored_Mannikkala_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(145)=(Name="DH-Armored_Maslova_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(146)=(Name="DH-Armored_Mickistein_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(147)=(Name="DH-Armored_Orel_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(148)=(Name="DH-Armored_Panzerschlacht_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    ...
    MapInfos(152)=(Name="DH-Armored_Studzianki_Clash.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Clash,Size=SIZE_Any)
    MapInfos(153)=(Name="DH-Armored_Suedwind_Advance.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Advance,Size=SIZE_Any)
    ...
    MapInfos(155)=(Name="DH-Armored_Tractable_Advance.rom",AlliedNation=NATION_USA,GameType=GAMETYPE_Advance,Size=SIZE_Any)
