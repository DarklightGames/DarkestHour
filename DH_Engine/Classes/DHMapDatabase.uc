...
defaultproperties
{
    ...
    MapInfos(5)=(Name="DH-Caen_Advance",AlliedNation=NATION_Canada,GameType=GAMETYPE_Advance,Size=SIZE_Large)
    ...
    MapInfos(80)=(Name="DH-Winter_Stalemate_Clash",AlliedNation=NATION_USSR,GameType=GAMETYPE_Clash,Size=SIZE_Medium)
    ...
    MapInfos(102)=(Name="DH-Reichswald_Advance",AlliedNation=NATION_Britain,GameType=GAMETYPE_Advance,Size=SIZE_Medium)
    ...
    MapInfos(169)=(Name="DH-Gorlitz_Defence",AlliedNation=NATION_Poland,GameType=GAMETYPE_Defence,Size=SIZE_Small)
}
