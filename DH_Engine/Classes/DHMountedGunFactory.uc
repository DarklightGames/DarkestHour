...
class DHMountedGunFactory extends DHVehicleFactory
    abstract;
...
var     array<DHMountedGunFactory> GunFactories;   // saved actor references to all gun factories in our group
...
{
    local DHMountedGunFactory GunFactory;
    local int            i;
    ...
    foreach DynamicActors(Class'DHMountedGunFactory', GunFactory)
    {
...
{
    local array<DHMountedGunFactory> TempGunFactories;
