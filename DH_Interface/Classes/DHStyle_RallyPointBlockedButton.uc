...
class DHStyle_RallyPointBlockedButton extends GUIStyles;

defaultproperties
{
    KeyName="DHRallyPointBlockedButtonStyle"
    ...
    Images(0)=material'DH_GUI_Tex.DeployMenu.RallyPointBlocked'
    Images(1)=material'DH_GUI_Tex.DeployMenu.RallyPointBlocked'
    Images(2)=material'DH_GUI_Tex.DeployMenu.RallyPointBlocked'
    Images(3)=material'DH_GUI_Tex.DeployMenu.RallyPointBlocked'
    Images(4)=material'DH_GUI_Tex.DeployMenu.RallyPointBlocked'
