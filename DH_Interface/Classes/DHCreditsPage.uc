...
defaultproperties
{
    ...
    CreditLines(98)="Thommy-L (Fatal Error)"
    CreditLines(99)="Carpathian Crosses Team"
    CreditLines(100)="Torben 'thens' Hensgens"
    CreditLines(101)=""
    CreditLines(102)="Special Thanks:"
    CreditLines(103)=""
    CreditLines(104)="A huge thanks goes out to all the former members of the Darklight Games team. Without their years of hard work, we would never have made it to this point. We're eternally grateful."
    CreditLines(105)="All of our testers over the years. You've helped create a (mostly) bug free experience!"
    CreditLines(106)="Alan, John, Dayle & all the guys at Tripwire Interactive for their assistance, support, and of course for the game that we all love so much."
    CreditLines(107)="Our faithful community who has stuck by us over the years and continue to offer support and ideas for the betterment of the game."
    CreditLines(108)="And to everyone else who has contributed to this mod over the years that we may have missed, thank you!"
