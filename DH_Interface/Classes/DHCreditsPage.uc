...
defaultproperties
{
    ...
    CreditLines(90)="Logan Laidlaw"
    CreditLines(91)="jmoney"
    CreditLines(92)=""
    CreditLines(93)="Other Contributors:"
    CreditLines(94)=""
    CreditLines(95)="After-Hourz Gaming Network"
    CreditLines(96)="All the lads from Splat"
    CreditLines(97)="The Wild Bunch"
    CreditLines(98)="Schneller"
    CreditLines(99)="Beppo and the lads from Sentry Studios"
    CreditLines(100)="Amizaur for vehicle optics code and German vehicle gun sights"
    CreditLines(101)="Thommy-L (Fatal Error)"
    CreditLines(102)="Carpathian Crosses Team"
    CreditLines(103)="Torben 'thens' Hensgens"
    CreditLines(104)=""
    CreditLines(105)="Special Thanks:"
    CreditLines(106)=""
    CreditLines(107)="A huge thanks goes out to all the former members of the Darklight Games team. Without their years of hard work, we would never have made it to this point. We're eternally grateful."
    CreditLines(108)="All of our testers over the years. You've helped create a (mostly) bug free experience!"
    CreditLines(109)="Alan, John, Dayle & all the guys at Tripwire Interactive for their assistance, support, and of course for the game that we all love so much."
    CreditLines(110)="Our faithful community who has stuck by us over the years and continue to offer support and ideas for the betterment of the game."
    CreditLines(111)="And to everyone else who has contributed to this mod over the years that we may have missed, thank you!"
