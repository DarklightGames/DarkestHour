// class: DH_MobileDeployVehicle_Allies
// Auther: Theel
// Date: 12-09-10
// Purpose:
...
class DH_MobileDeployVehicle_Allies extends DH_M3A1HalftrackTransport;
...
defaultproperties
{
     ...
     PointValue=3.000000
     bNeverReset=true
     Skins(0)=Texture'DH_MDV_Tex.AlliedMDV.M3A1Halftrack_body_ext'
}
