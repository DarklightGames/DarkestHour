...
defaultproperties
{
    ...
    PA_IdleDeployedAnim="stand_idleiron_kar"
    PA_IdleDeployedProneAnim="prone_idle_kar"
    PA_IdleDeployedCrouchAnim="crouch_idleiron_kar"
    PA_ReloadAnim="stand_reloadhalf_svt40"
    PA_ProneReloadAnim="prone_reloadhalf_svt40"
    PA_ReloadEmptyAnim="stand_reloadhalf_svt40"
    PA_ProneReloadEmptyAnim="prone_reloadhalf_svt40"
    PA_ProneIdleRestAnim="Prone_idle_kar"
    PA_StandWeaponDeployAnim="stand_idleiron_kar"
    PA_ProneWeaponDeployAnim="prone_idle_kar"
    PA_StandWeaponUnDeployAnim="stand_idleiron_kar"
    PA_ProneWeaponUnDeployAnim="prone_idle_kar"
    PA_Fire="stand_shoothip_kar"
    PA_IronFire="stand_shootiron_kar"
    PA_CrouchFire="crouch_shoot_kar"
    PA_ProneFire="prone_shoot_kar"
    PA_DeployedFire="stand_shootiron_kar"
    PA_CrouchDeployedFire="crouch_shootiron_kar"
    PA_ProneDeployedFire="prone_shoot_kar"
