...
class DH_M1GarandGrenadeFire extends DHSemiAutoFire;
...
{
    if (DH_M1GarandGrenadeWeapon(Weapon) != none && DH_M1GarandGrenadeWeapon(Weapon).WasLastRound())
    {
...
function PlayFiring()
{
    local DH_M1GarandGrenadeWeapon Garand;
    local name              Anim;
    local sound             FiringSound;
    local bool              bLastRound;

    Garand = DH_M1GarandGrenadeWeapon(Weapon);
