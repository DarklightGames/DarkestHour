...
defaultproperties
{
    ...
    RangeSettings(0)=(FirePitch=0,IronIdleAnim="Iron_idle",IronFireAnim="iron_shoot")
    RangeSettings(1)=(FirePitch=350,IronIdleAnim="iron_idleMid",IronFireAnim="iron_shootMid")
    RangeSettings(2)=(FirePitch=675,IronIdleAnim="iron_idleFar",IronFireAnim="iron_shootFar")
}
