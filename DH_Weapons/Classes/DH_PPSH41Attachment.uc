...
defaultproperties
{
     ...
     PA_LimpAnims(0)="stand_limpFhip_ppsh"
     PA_LimpAnims(1)="stand_limpBhip_ppsh"
     PA_LimpAnims(2)="stand_limpLhip_ppsh"
     PA_LimpAnims(3)="stand_limpRhip_ppsh"
     PA_LimpAnims(4)="stand_limpFLhip_ppsh"
     PA_LimpAnims(5)="stand_limpFRhip_ppsh"
     PA_LimpAnims(6)="stand_limpBLhip_ppsh"
     PA_LimpAnims(7)="stand_limpBRhip_ppsh"
     PA_LimpIronAnims(0)="stand_limpFiron_ppsh"
     PA_LimpIronAnims(1)="stand_limpBiron_ppsh"
     PA_LimpIronAnims(2)="stand_limpLiron_ppsh"
     PA_LimpIronAnims(3)="stand_limpRiron_ppsh"
     PA_LimpIronAnims(4)="stand_limpFLiron_ppsh"
     PA_LimpIronAnims(5)="stand_limpFRiron_ppsh"
     PA_LimpIronAnims(6)="stand_limpBLiron_ppsh"
     PA_LimpIronAnims(7)="stand_limpBRiron_ppsh"
     ...
     PA_HitFAnim="hitF_ppsh"
     PA_HitBAnim="hitB_ppsh"
     PA_HitLAnim="hitL_ppsh"
     PA_HitRAnim="hitR_ppsh"
     PA_HitLLegAnim="hitL_leg_ppsh"
     PA_HitRLegAnim="hitR_leg_ppsh"
     ...
     menuImage=Texture'InterfaceArt_tex.Menu_weapons.PPSH'
