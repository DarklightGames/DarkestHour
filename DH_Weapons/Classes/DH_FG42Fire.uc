...
defaultproperties
{
    ...
    RecoilCurve=(Points=((InVal=0.0,OutVal=0.5),(InVal=2.0,OutVal=0.6),(InVal=3.0,OutVal=0.7),(InVal=4.0,OutVal=1.5),(InVal=10.0,OutVal=2.5),(InVal=10000000000.0,OutVal=1.0)))
