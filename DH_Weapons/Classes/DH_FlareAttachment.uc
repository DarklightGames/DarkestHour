...
class DH_FlareAttachment extends DHWeaponAttachment;
...
defaultproperties
{
     ...
     PA_LimpAnims(0)="stand_limpFhip_mp40"
     PA_LimpAnims(1)="stand_limpBhip_mp40"
     PA_LimpAnims(2)="stand_limpLhip_mp40"
     PA_LimpAnims(3)="stand_limpRhip_mp40"
     PA_LimpAnims(4)="stand_limpFLhip_mp40"
     PA_LimpAnims(5)="stand_limpFRhip_mp40"
     PA_LimpAnims(6)="stand_limpBLhip_mp40"
     PA_LimpAnims(7)="stand_limpBRhip_mp40"
     PA_LimpIronAnims(0)="stand_limpFiron_mp40"
     PA_LimpIronAnims(1)="stand_limpBiron_mp40"
     PA_LimpIronAnims(2)="stand_limpLiron_mp40"
     PA_LimpIronAnims(3)="stand_limpRiron_mp40"
     PA_LimpIronAnims(4)="stand_limpFLiron_mp40"
     PA_LimpIronAnims(5)="stand_limpFRiron_mp40"
     PA_LimpIronAnims(6)="stand_limpBLiron_mp40"
     PA_LimpIronAnims(7)="stand_limpBRiron_mp40"
     ...
     PA_HitFAnim="hitF_mp40"
     PA_HitBAnim="hitB_mp40"
     PA_HitLAnim="hitL_mp40"
     PA_HitRAnim="hitR_mp40"
     PA_HitLLegAnim="hitL_leg_mp40"
     PA_HitRLegAnim="hitR_leg_mp40"
     ...
     PA_TakeoffAnims(2)="jumpL_takoff_mp40"
     PA_TakeoffAnims(3)="jumpR_takoff_mp40"
