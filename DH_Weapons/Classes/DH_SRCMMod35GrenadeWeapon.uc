...
defaultproperties
{
    ...
    FireModeClass(0)=Class'DH_SRCMMod35GrenadeFire'
    FireModeClass(1)=Class'DH_SRCMMod35GrenadeTossFire'
    AttachmentClass=Class'DH_SRCMMod35GrenadeAttachment'
    PickupClass=Class'DH_SRCMMod35GrenadePickup'
