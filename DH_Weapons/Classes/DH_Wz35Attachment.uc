...
defaultproperties
{
    ...
    PA_ProneIronAnims(3)="prone_slowcrawlR_ptrd"  //i dont think these work because the ptrd/wz is locked to one spot when ironed
    ...
    PA_IronFireLastShot="stand_shootironwz35"
