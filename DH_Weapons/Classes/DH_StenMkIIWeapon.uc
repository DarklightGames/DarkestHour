...
{
    ItemName="STEN Mk.II"
    FireModeClass(0)=Class'DH_StenMkIIFire'
    FireModeClass(1)=Class'DH_StenMkIIMeleeFire'
    AttachmentClass=Class'DH_StenMkIIAttachment'
    PickupClass=Class'DH_StenMkIIPickup'
