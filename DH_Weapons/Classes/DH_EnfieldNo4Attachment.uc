...
defaultproperties
{
    ...
    MenuDescription="Standard bolt-action battle rifle for the British and Commonwealth forces. Fires a .303 cartridge from a 10-round mag, or from two 5-round stripper clips. Mounts a 7-inch spike bayonet for close quarters combat. Effective range: 500-550 metres."
    bRapidFire=false
