...
defaultproperties
{
     ...
     PA_CrouchIronFire="crouch_shootiron_stg44"
     ...
     PA_AirStillAnim="jump_mid_stg44"
     PA_AirAnims(0)="jumpF_mid_stg44"
     PA_AirAnims(1)="jumpB_mid_stg44"
     PA_AirAnims(2)="jumpL_mid_stg44"
     PA_AirAnims(3)="jumpR_mid_stg44"
     PA_TakeoffStillAnim="jump_takeoff_stg44"
     PA_TakeoffAnims(0)="jumpF_takeoff_stg44"
     PA_TakeoffAnims(1)="jumpB_takeoff_stg44"
     PA_TakeoffAnims(2)="jumpL_takoff_stg44"
     PA_TakeoffAnims(3)="jumpR_takoff_stg44"
     PA_LandAnims(0)="jumpF_land_stg44"
     PA_LandAnims(1)="jumpB_land_stg44"
     PA_LandAnims(2)="jumpL_land_stg44"
     PA_LandAnims(3)="jumpR_land_stg44"
     PA_DodgeAnims(0)="jumpF_mid_stg44"
     PA_DodgeAnims(1)="jumpB_mid_stg44"
     PA_DodgeAnims(2)="jumpL_mid_stg44"
     PA_DodgeAnims(3)="jumpR_mid_stg44"
     WA_Idle="idle_sten"
