...
defaultproperties
{
    ...
    Constructions(10)=(ConstructionClass=Class'DH_M5GunConstruction',Limit=3,MaxActive=-1)
    Constructions(11)=(ConstructionClass=Class'DH_M1MortarConstruction',Limit=3,MaxActive=-1)
    Constructions(12)=(ConstructionClass=Class'DH_M116GunConstruction',Limit=3,MaxActive=-1)
    Constructions(13)=(ConstructionClass=Class'DH_M1919A4GunConstruction',Limit=6,MaxActive=-1)
}
