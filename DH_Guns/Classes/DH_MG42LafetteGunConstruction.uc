...
class DH_MG42LafetteGunConstruction extends DHConstruction_Vehicle;

defaultproperties
{
    MenuIcon=Texture'DH_InterfaceArt2_tex.mg'
    VehicleClasses(0)=(VariantIndex=0,VehicleClass=Class'DH_MG42LafetteGun')
    VehicleClasses(1)=(VariantIndex=1,VehicleClass=Class'DH_MG42LafetteGun_Low')
    SupplyCost=500
    ProgressMax=5
