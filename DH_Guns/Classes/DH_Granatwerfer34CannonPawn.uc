...
defaultproperties
{
    ...
    FiringCameraBone="RELOAD_CAMERA"
    FiringCameraBoneChannel=3
    GunFireAnim="FIRINGCAMERA"

    // enormous brainwave, we can just reuse the same hand animations and change the offset so that it matches the tube location
    HandsMesh=SkeletalMesh'DH_Model35Mortar_anm.model35mortar_hands'
    HandsFireAnims=("FIRE_HANDS")
    HandsAttachBone="GUN_PITCH"
