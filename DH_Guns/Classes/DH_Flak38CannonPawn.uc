...
defaultproperties
{
    ...
    DriverPositions(1)=(ViewLocation=(X=-1.0,Y=0.0,Z=0.0),ViewFOV=90.0,PositionMesh=SkeletalMesh'DH_Flak38_anm.Flak38_turret',TransitionUpAnim="lookover_up",TransitionDownAnim="optic_in",bExposed=true)
    DriverPositions(2)=(ViewLocation=(X=-1.0,Y=0.0,Z=0.0),ViewFOV=90.0,PositionMesh=SkeletalMesh'DH_Flak38_anm.Flak38_turret',TransitionDownAnim="lookover_down",ViewPitchUpLimit=6000,ViewPitchDownLimit=63500,ViewPositiveYawLimit=20000,ViewNegativeYawLimit=-20000,bExposed=true)
    ...
    bCamOffsetRelToGunPitch=true // makes the camera location offset follow the gun's pitch when on open sights
