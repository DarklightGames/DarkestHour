...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=5.0,Y=-19.5,Z=36.5),ViewFOV=34.0,TransitionUpAnim="com_open",DriverTransitionAnim="crouch_idle_binoc",ViewPositiveYawLimit=20000,ViewNegativeYawLimit=-20000,bDrawOverlays=true,bExposed=true) // view limits only relevant during transition down, to avoid snap to front at start
    ...
    GunsightSize=0.4412 // 15 degrees visible FOV at 2.5x magnification (telescopic gunsight model?) // TODO: verify sight details are correct (not sure what direct fire sight it had)
