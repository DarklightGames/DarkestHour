...
defaultproperties
{
     ...
     DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Hetzer_anm_V3.Hetzer_MG',TransitionUpAnim="MG_open",DriverTransitionAnim="VT60_com_close")
     DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Hetzer_anm_V3.Hetzer_MG',TransitionDownAnim="MG_close",DriverTransitionAnim="VT60_com_open")
     DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Hetzer_anm_V3.Hetzer_MG')
     GunClass=Class'DH_Hetzer--leave_in_cache.DH_HetzerMountedMG'
