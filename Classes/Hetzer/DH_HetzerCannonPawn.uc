...
defaultproperties
{
     ...
     GunsightSize=0.471000
     AmmoShellTexture=Texture'InterfaceArt_tex.Tank_Hud.panzer4F2shell'
     AmmoShellReloadTexture=Texture'InterfaceArt_tex.Tank_Hud.panzer4F2shell_reload'
     DriverPositions(0)=(ViewLocation=(X=37.000000,Y=-35.000000,Z=12.000000),ViewFOV=27.000000,bDrawOverlays=True)
     ...
     GunClass=Class'DH_Hetzer--leave_in_cache.DH_HetzerCannon'
     bHasAltFire=False
