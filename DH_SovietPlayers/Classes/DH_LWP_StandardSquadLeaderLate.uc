...
defaultproperties
{
    ...
    RolePawns(4)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicSLGreyPawn',Weight=1.0)
    RolePawns(5)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicSLGreyPawnB',Weight=2.0)
    RolePawns(6)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicSLGreyPawnC',Weight=2.0)
