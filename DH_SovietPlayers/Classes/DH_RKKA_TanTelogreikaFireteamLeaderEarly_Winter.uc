...
class DH_RKKA_TanTelogreikaFireteamLeaderEarly_Winter extends DHSOVCorporalRoles;

defaultproperties
{
    RolePawns(0)=(PawnClass=class'DH_SovietPlayers.DH_SovietTanTeloSLEarlyPawn_Winter',Weight=1.0)
