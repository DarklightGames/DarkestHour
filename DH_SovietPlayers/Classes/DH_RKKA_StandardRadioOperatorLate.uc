...
defaultproperties
{
    ...
    RolePawns(3)=(PawnClass=class'DH_SovietPlayers.DH_SovietTunicM43GreenPawnAStraps',Weight=1.0)
    RolePawns(5)=(PawnClass=class'DH_SovietPlayers.DH_SovietTunicM43DarkPawnAStraps',Weight=1.0)
