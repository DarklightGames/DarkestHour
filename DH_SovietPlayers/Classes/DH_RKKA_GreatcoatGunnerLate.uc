...
class DH_RKKA_GreatcoatGunnerLate extends DHSOVMachineGunnerRoles;
...
defaultproperties
{
    ...
    RolePawns(3)=(PawnClass=class'DH_SovietPlayers.DH_SovietGreatcoatBrownLatePawn',Weight=1.0)
