...
defaultproperties
{
    RolePawns(0)=(PawnClass=Class'DH_LWPTunicMixLightPawn',Weight=2.0)
    RolePawns(1)=(PawnClass=Class'DH_LWPTunicBackpackLightPawn',Weight=2.0)
    RolePawns(2)=(PawnClass=Class'DH_LWPTunicLightPawn',Weight=2.0)
