...
defaultproperties
{
    ...
    RolePawns(0)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicBackpackLatePawn',Weight=6.0)
    RolePawns(1)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicNocoatLatePawn',Weight=4.0)
    RolePawns(2)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicBackpackLatePawnM35',Weight=1.0)
    RolePawns(3)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicNocoatLatePawnM35',Weight=1.0)
