...
defaultproperties
{
    ...
    RolePawns(4)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicSLGreyPawn',Weight=2.0)
    RolePawns(5)=(PawnClass=class'DH_SovietPlayers.DH_LWPTunicBackpackGreyPawn',Weight=2.0)
