...
class DH_RKKF_FireteamLeaderNorth extends DHSOVCorporalRoles; //this role wears a naval cap, which has a different writing on it depending on the fleet, so this role is separated on fleets
