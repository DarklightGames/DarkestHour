...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=25.0,Y=-25.2.0,Z=8.0),ViewFOV=25,PositionMesh=SkeletalMesh'DH_Wolverine_anm.M10_turret_ext',ViewPitchUpLimit=3641,ViewPitchDownLimit=63351,bDrawOverlays=true,bExposed=true)
