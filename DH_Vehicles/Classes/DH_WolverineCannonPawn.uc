...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=35.0,Y=-10.0,Z=8.0),ViewFOV=28.33,PositionMesh=SkeletalMesh'DH_Wolverine_anm.M10_turret_ext',ViewPitchUpLimit=3641,ViewPitchDownLimit=63351,bDrawOverlays=true,bExposed=true)
    ...
    GunsightSize=0.435 // 12.3 degrees visible FOV at 3x magnification (M70G sight)
