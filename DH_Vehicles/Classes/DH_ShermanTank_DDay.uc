...
class DH_ShermanTank_DDay extends DHArmoredVehicle;
...
defaultproperties
{
    ...
    DamagedEffectOffset=(X=-107.0,Y=0.0,Z=94.0)
    VehicleTeam=1
    SteeringScaleFactor=0.75
    BeginningIdleAnim="driver_hatch_idle_close"
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=5500,ViewNegativeYawLimit=-5500,ViewFOV=90.0,bDrawOverlays=true)
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionUpAnim="driver_hatch_open",TransitionDownAnim="Overlay_In",DriverTransitionAnim="VPanzer4_driver_close",ViewPitchUpLimit=3000,ViewPitchDownLimit=61922,ViewPositiveYawLimit=8000,ViewNegativeYawLimit=-8000,ViewFOV=90.0)
    DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer4_driver_open",ViewPitchUpLimit=5000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=true,ViewFOV=90.0)
    ...
    VehHitpoints(2)=(PointRadius=15.0,PointScale=1.0,PointBone="body",PointOffset=(X=15.0,Y=55.0,Z=32.0),DamageMultiplier=3.0,HitPointType=HP_AmmoStore)
    VehHitpoints(3)=(PointRadius=15.0,PointScale=1.0,PointBone="body",PointOffset=(X=15.0,Y=-55.0,Z=32.0),DamageMultiplier=3.0,HitPointType=HP_AmmoStore)
    VehHitpoints(4)=(PointRadius=25.0,PointScale=1.0,PointBone="body",PointOffset=(X=-10.0,Z=25.0),DamageMultiplier=5.0,HitPointType=HP_AmmoStore)
    ...
    Begin Object Class=SVehicleWheel Name=LF_Steering
        ...
        BoneRollAxis=AXIS_Y
        BoneOffset=(X=30.0,Y=-16.0,Z=12.0)
        WheelRadius=33.0
    End Object
