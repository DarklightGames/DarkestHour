...
//
// American M4A1 (Sherman) 75mm tank - "swimming" version
//==============================================================================
class DH_ShermanTank_DDay extends DH_ROTreadCraftB;
...
defaultproperties
{
     ...
     DamagedEffectOffset=(X=-107.000000,Y=0.000000,Z=94.000000)
     VehicleTeam=1
     SteeringScaleFactor=0.750000
     BeginningIdleAnim="driver_hatch_idle_close"
     DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=5500,ViewNegativeYawLimit=-5500,ViewFOV=85.000000,bDrawOverlays=True)
     DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionUpAnim="driver_hatch_open",TransitionDownAnim="Overlay_In",DriverTransitionAnim="VPanzer4_driver_close",ViewPitchUpLimit=3000,ViewPitchDownLimit=61922,ViewPositiveYawLimit=8000,ViewNegativeYawLimit=-8000,ViewFOV=85.000000)
     DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Sherman_anm.ShermanM4A1_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer4_driver_open",ViewPitchUpLimit=5000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=True,ViewFOV=85.000000)
     ...
     VehHitpoints(2)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(X=15.000000,Y=55.000000,Z=32.000000),DamageMultiplier=3.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(3)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(X=15.000000,Y=-55.000000,Z=32.000000),DamageMultiplier=3.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(4)=(PointRadius=25.000000,PointScale=1.000000,PointBone="body",PointOffset=(X=-10.000000,Z=25.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     ...
     Begin Object Class=SVehicleWheel Name=LF_Steering
         ...
         BoneRollAxis=AXIS_Y
         BoneOffset=(X=30.000000,Y=-16.000000,Z=12.000000)
         WheelRadius=33.000000
     End Object
     Wheels(0)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.LF_Steering'
     ...
     Begin Object Class=SVehicleWheel Name=RF_Steering
         ...
         WheelRadius=33.000000
     End Object
     Wheels(1)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.RF_Steering'
     ...
     Begin Object Class=SVehicleWheel Name=LR_Steering
         ...
         WheelRadius=33.000000
     End Object
     Wheels(2)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.LR_Steering'
     ...
     Begin Object Class=SVehicleWheel Name=RR_Steering
         ...
         WheelRadius=33.000000
     End Object
     Wheels(3)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.RR_Steering'
     ...
     Begin Object Class=SVehicleWheel Name=Left_Drive_Wheel
         ...
         WheelRadius=33.000000
     End Object
     Wheels(4)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.Left_Drive_Wheel'
     ...
     Begin Object Class=SVehicleWheel Name=Right_Drive_Wheel
         ...
         WheelRadius=33.000000
     End Object
     Wheels(5)=SVehicleWheel'DH_Vehicles.DH_ShermanTank_DDay.Right_Drive_Wheel'

     VehicleMass=13.500000
     bFPNoZFromCameraPitch=True
     DrivePos=(X=7.000000,Y=0.000000,Z=3.000000)
     ExitPositions(0)=(X=100.000000,Y=-150.000000,Z=100.000000)
     ExitPositions(1)=(X=100.000000,Y=100.000000,Z=100.000000)
     ...
     Skins(1)=Texture'DH_VehiclesUS_tex.int_vehicles.Sherman_body_int'
     Skins(2)=Texture'DH_VehiclesUS_tex.int_vehicles.Sherman_hatch_int'
     Skins(3)=Texture'DH_VehiclesUS_tex.ext_vehicles.Sherman_scoop_ext'
     ...
     End Object
     KParams=KarmaParamsRBFull'DH_Vehicles.DH_ShermanTank_DDay.KParams0'
