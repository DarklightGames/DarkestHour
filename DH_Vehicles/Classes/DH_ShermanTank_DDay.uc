...
defaultproperties
{
    ...
    VehHitpoints(0)=(PointOffset=(X=-6.0))
    VehHitpoints(1)=(PointRadius=30.0,PointOffset=(X=-90.0,Z=60.0))
    ...
    Skins(6)=texture'DH_VehiclesUS_tex.ext_vehicles.Sherman_scoop_ext'
