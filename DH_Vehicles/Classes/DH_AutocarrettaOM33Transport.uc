...
defaultproperties
{
    ...
    RandomAttachmentGroups(2)=(Dependencies=((GroupIndex=1,OptionIndex=-1)),Options=((Probability=1.0,Attachment=(AttachBone="BODY",StaticMesh=StaticMesh'DH_AutocarrettaOM_stc.ATTACHMENTS.OM33_ROOF_BELTS'))))
