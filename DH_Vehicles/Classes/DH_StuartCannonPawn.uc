...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=12.0,Y=-9.5,Z=7.0),ViewFOV=24.0,PositionMesh=SkeletalMesh'DH_Stuart_anm.Stuart_turret_ext',ViewPitchUpLimit=3641,ViewPitchDownLimit=63352,bDrawOverlays=true)
