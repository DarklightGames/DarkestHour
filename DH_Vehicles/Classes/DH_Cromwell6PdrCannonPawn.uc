...
defaultproperties
{
    ...
    DriverPositions(1)=(ViewFOV=90.0,PositionMesh=SkeletalMesh'DH_Cromwell_anm.cromwell6pdr_turret_int',TransitionUpAnim="com_open",DriverTransitionAnim="VT3485_com_close",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=12000,ViewNegativeYawLimit=-12000,bDrawOverlays=true)
    ...
    DriverPositions(3)=(ViewFOV=12.0,PositionMesh=SkeletalMesh'DH_Cromwell_anm.cromwell6pdr_turret_int',ViewPitchUpLimit=10000,ViewPitchDownLimit=63500,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000,bDrawOverlays=true,bExposed=true)
