...
defaultproperties
{
    ...
    Skins(1)=Texture'DH_VehiclesGE_tex2.tiger2B_turret_int'
    CollisionStaticMeshes(0)=(CollisionStaticMesh=StaticMesh'DH_German_vehicles_stc2.Tiger2B_turret_col')
