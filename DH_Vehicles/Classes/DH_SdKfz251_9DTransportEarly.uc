...
class DH_SdKfz251_9DTransportEarly extends DH_Sdkfz251Transport;
...
defaultproperties
{
    ...
    PassengerWeapons(0)=(WeaponPawnClass=class'DH_Vehicles.DH_SdKfz251_9DCannonPawnEarly',WeaponBone="mg_base")
    ...
    VehicleNameString="Sd.Kfz.251/9B Stummel"
