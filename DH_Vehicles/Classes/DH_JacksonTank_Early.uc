...
defaultproperties
{
    ...
    DestroyedMeshSkins(5)=Texture'DH_VehiclesGE_tex2.Alpha' // hides the muzzle brake in the DestroyedVehicleMesh
    SpawnOverlay(0)=Material'DH_InterfaceArt_tex.m36_jackson_early'
}
