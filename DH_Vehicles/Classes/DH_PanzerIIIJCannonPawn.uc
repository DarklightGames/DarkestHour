...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=30.0,Y=-22.0,Z=1.5),ViewFOV=34.0,PositionMesh=SkeletalMesh'DH_Panzer3_anm.Panzer3J_turret_int',ViewPitchUpLimit=3641,ViewPitchDownLimit=63715,ViewPositiveYawLimit=19000,ViewNegativeYawLimit=-20000,bDrawOverlays=true)
