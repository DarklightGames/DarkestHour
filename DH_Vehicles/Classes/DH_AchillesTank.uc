...
defaultproperties
{
    ...
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Wolverine_anm.Achilles_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=5500,ViewNegativeYawLimit=-5500,ViewFOV=90.000000,bDrawOverlays=true)
    ...
    DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Wolverine_anm.Achilles_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer3_driver_idle_open",ViewPitchUpLimit=10000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=true,ViewFOV=90.000000)
