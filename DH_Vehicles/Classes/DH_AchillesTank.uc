...
defaultproperties
{
    ...
    DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Wolverine_anm.Achilles_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer3_driver_idle_open",ViewPitchUpLimit=10000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=true,ViewFOV=90.0)
    ...
    VehHitpoints(0)=(PointOffset=(X=2.0),bPenetrationPoint=false)
    VehHitpoints(1)=(PointRadius=35.0,PointOffset=(X=-90.0,Z=-35.0),DamageMultiplier=1.0)
