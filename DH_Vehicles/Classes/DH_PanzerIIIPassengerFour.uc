...
//===================================================================
class DH_PanzerIIIPassengerFour extends DH_ROPassengerPawn;

defaultproperties
{
     PositionInArray=5
     CameraBone="body"
     DrivePos=(X=-90.000000,Y=60.000000,Z=50.000000)
     DriveRot=(Yaw=16384)
     DriveAnim="VHalftrack_Rider5_idle"
     ExitPositions(0)=(X=-90.000000,Y=200.000000)
     ExitPositions(1)=(X=-90.000000,Y=-200.000000)
     ExitPositions(2)=(X=-180.000000,Y=90.000000,Z=100.000000)
     EntryRadius=375.000000
     FPCamPos=(X=-90.000000,Y=60.000000,Z=95.000000)
