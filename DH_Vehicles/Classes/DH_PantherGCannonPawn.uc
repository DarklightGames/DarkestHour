...
defaultproperties
{
    ...
    GunsightPositions=2 // ausf.G has dual magnification optics (so all positions above shift down 1 - note need for overridden zero ViewFOV, which just makes it use player's default view FOV)
