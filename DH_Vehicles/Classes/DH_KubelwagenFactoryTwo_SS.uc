//===================================================================
// VWType82Factory_SS (Mid to Late War - DunkelGelb Camo scheme for SS)
//
...
//===================================================================
class DH_KubelwagenFactoryTwo_SS extends DH_KubelwagenFactory_WH;

defaultproperties
{
     VehicleClass=Class'DH_Vehicles.DH_KubelwagenCarTwo_SS'
