...
defaultproperties
{
    ...
    Skins(1)=Texture'DH_VehiclesGE_tex2.Stug3g_body_int'
    Skins(2)=Texture'Weapons3rd_tex.mg34_world'
    bMatchSkinToVehicle=true
    CollisionStaticMeshes(0)=(CollisionStaticMesh=StaticMesh'DH_German_vehicles_stc2.StuH_remoteMG_coll')
    ...
    // Reload
    ReloadStages(0)=(Sound=Sound'Inf_Weapons_Foley.mg34_reload01_000',Duration=1.24) // differs from defaults because uses ammo drums & not belts
