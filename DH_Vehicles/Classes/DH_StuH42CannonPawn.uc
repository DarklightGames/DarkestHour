...
//
// German SturmHaubitze 42 Ausf.G assault gun cannon pawn
//==============================================================================
...
defaultproperties
{
     ...
     DriverPositions(2)=(ViewFOV=80.000000,PositionMesh=SkeletalMesh'DH_Stug3G_anm.StuH_turret_int',TransitionUpAnim="com_open",DriverTransitionAnim="stand_idlehip_binoc",ViewPitchUpLimit=10000,ViewPitchDownLimit=64500,ViewPositiveYawLimit=65536,ViewNegativeYawLimit=-65536)
     DriverPositions(3)=(ViewFOV=80.000000,PositionMesh=SkeletalMesh'DH_Stug3G_anm.StuH_turret_int',TransitionDownAnim="com_close",DriverTransitionAnim="VStug3_com_open",ViewPitchUpLimit=10000,ViewPitchDownLimit=64500,ViewPositiveYawLimit=65536,ViewNegativeYawLimit=-65536,bExposed=True)
     ...
     VehiclePositionString="in a StuH42 Ausf.G cannon"
     VehicleNameString="StuH42 Ausf.G cannon"
     PitchUpLimit=6000
