...
defaultproperties
{
    ...
    DriverPositions(1)=(ViewLocation=(Z=10.0),ViewFOV=7.2,PositionMesh=SkeletalMesh'DH_Stug3G_anm.StuH_turret_int',ViewPitchUpLimit=1200,ViewPitchDownLimit=64500,ViewPositiveYawLimit=12000,ViewNegativeYawLimit=-12000,bDrawOverlays=true)
