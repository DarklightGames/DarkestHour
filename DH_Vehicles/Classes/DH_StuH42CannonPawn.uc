...
defaultproperties
{
    GunClass=Class'DH_StuH42Cannon'
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Stug3G_anm.StuH_turret_int')
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Stug3G_anm.StuH_turret_int')
