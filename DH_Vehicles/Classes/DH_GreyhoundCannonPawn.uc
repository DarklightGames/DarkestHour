...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=25.0,Y=-17.0,Z=3.0),ViewFOV=24.0,PositionMesh=SkeletalMesh'DH_Greyhound_anm.Greyhound_turret_ext',TransitionUpAnim="com_open",DriverTransitionAnim="VSU76_com_close",ViewPitchUpLimit=3641,ViewPitchDownLimit=63716,bDrawOverlays=true,bExposed=true)
    ...
    DriverPositions(2)=(ViewFOV=12.0,PositionMesh=SkeletalMesh'DH_Greyhound_anm.Greyhound_turret_ext',DriverTransitionAnim="stand_idleiron_binoc",ViewPitchUpLimit=10000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000,bDrawOverlays=true,bExposed=true)
