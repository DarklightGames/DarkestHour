...
//
// M36 American tank destroyer "Jackson"
//==============================================================================
class DH_JacksonTank extends DH_ROTreadCraftB;


#exec OBJ LOAD FILE=..\Animations\DH_Jackson_anm.ukx
#exec OBJ LOAD FILE=..\textures\DH_VehiclesUS_tex4.utx
...
defaultproperties
{
     ...
     VehicleHudThreadsScale=0.630000
     ...
     DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Jackson_anm.Jackson_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=5500,ViewNegativeYawLimit=-5500,ViewFOV=80.000000,bDrawOverlays=True)
     ...
     DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Jackson_anm.Jackson_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer3_driver_idle_open",ViewPitchUpLimit=10000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=True,ViewFOV=80.000000)
     ...
     VehHitpoints(2)=(PointRadius=15.000000,PointScale=1.000000,PointBone="Jackson_body_ext",PointOffset=(X=20.000000,Y=55.000000,Z=-8.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(3)=(PointRadius=15.000000,PointScale=1.000000,PointBone="Jackson_body_ext",PointOffset=(X=20.000000,Y=-55.000000,Z=-8.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(4)=(PointRadius=25.000000,PointScale=1.000000,PointBone="Jackson_body_ext",PointOffset=(X=-20.000000,Z=-20.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     ...
     VehiclePositionString="in a M36 Jackson"
