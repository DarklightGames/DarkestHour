...
defaultproperties
{
    ...
    // TODO: something wrong with the cupola position, camera starts in wrong position but is ok after unbuttoning & buttoning - missing/incorrect start/idle anim
    ...
    DestroyedGunsightOverlay=texture'DH_VehicleOpticsDestroyed_tex.Allied.Sherman_sight_destroyed' // TODO: use/make one for T34/Soviets
