...
defaultproperties
{
    ...
    Skins(0)=Texture'Weapons3rd_tex.dtmg_world'
    ...
    ReloadStages(0)=(Sound=Sound'Inf_Weapons_Foley.DT_reloadempty01_000',Duration=1.73) // no sounds because HUD overlay reload animation plays them
    ReloadStages(1)=(Sound=Sound'Inf_Weapons_Foley.DT_reloadempty02_052',Duration=2.23,HUDProportion=0.65)
    ReloadStages(2)=(Sound=Sound'Inf_Weapons_Foley.DT_reloadempty03_121',Duration=2.37)
    ReloadStages(3)=(Sound=Sound'Inf_Weapons_Foley.DT_reloadempty04_191',Duration=3.27,HUDProportion=0.35)
}
