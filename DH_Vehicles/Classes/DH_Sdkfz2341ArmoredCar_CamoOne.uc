...
defaultproperties
{
    ...
    CannonSkins(0)=Texture'DH_VehiclesGE_tex6.ext_vehicles.sdkfz2341_body_camo1'
    CannonSkins(1)=Texture'DH_VehiclesGE_tex6.ext_vehicles.sdkfz2341_extras_camo1'
