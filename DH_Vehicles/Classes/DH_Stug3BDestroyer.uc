...
class DH_Stug3BDestroyer extends DHArmoredVehicle; // earlier version without remote-controlled MG & with boxy mantlet

defaultproperties
{
    // Vehicle properties
    VehicleNameString="StuG III Ausf.B"
    VehicleMass=12.0
    ReinforcementCost=4

    // Hull mesh
    Mesh=SkeletalMesh'DH_Stug3B_anm.Stug3b_body_ext'
    Skins(0)=Texture'DH_VehiclesGE_tex8.ext_vehicles.Stug3b_ext'
    Skins(1)=Texture'DH_VehiclesGE_tex2.Treads.Stug3g_treads'
    Skins(2)=Texture'DH_VehiclesGE_tex2.Treads.Stug3g_treads'
    Skins(3)=Texture'DH_VehiclesGE_tex8.int_vehicles.Stug3b_body_int'
    FireEffectOffset=(X=25.0,Y=0.0,Z=-25.0)

    // Vehicle weapons & passengers
    PassengerWeapons(0)=(WeaponPawnClass=class'DH_Vehicles.DH_Stug3BCannonPawn',WeaponBone="Turret_placement")
    //PassengerPawns(0)=(AttachBone="passenger_01",DrivePos=(X=8.0,Y=0.0,Z=3.0),DriveRot=(Yaw=49152),DriveAnim="VHalftrack_Rider4_idle") TODO: ADD PASSENGERS
    ...
    // Driver
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Stug3B_anm.Stug3b_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=12000,ViewPitchDownLimit=60000,ViewPositiveYawLimit=12000,ViewNegativeYawLimit=-12000)
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Stug3B_anm.Stug3b_body_int',TransitionUpAnim="periscope_in",TransitionDownAnim="Overlay_In",ViewPitchUpLimit=2000,ViewPitchDownLimit=63500,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-6000)
    DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Stug3B_anm.Stug3b_body_int',TransitionDownAnim="periscope_out",ViewPitchUpLimit=1,ViewPitchDownLimit=65536,ViewPositiveYawLimit=1,ViewNegativeYawLimit=-1,bDrawOverlays=true)
    PeriscopeOverlay=Texture'Vehicle_Optic.Scopes.MG_sight'
    PeriscopeSize=0.765
    bDrawDriverInTP=false

    // Hull armor TODO: Upper Super and Beyond
    FrontArmor(0)=(Thickness=3.0,Slope=-86.0,MaxRelativeHeight=-26.5,LocationName="lower nose")
    FrontArmor(1)=(Thickness=5.0,Slope=-30.0,MaxRelativeHeight=3.5,LocationName="nose")
    FrontArmor(2)=(Thickness=5.0,Slope=50.0,MaxRelativeHeight=19,LocationName="upper nose")
    FrontArmor(3)=(Thickness=5.0,Slope=9.0,MaxRelativeHeight=41.5,LocationName="DFP")
    ...
    VehHitpoints(0)=(PointRadius=25.0,PointHeight=25.0,PointOffset=(X=-90.0)) // engine
    ...
    NewVehHitpoints(0)=(PointRadius=5.0,PointBone="body",PointOffset=(X=53.0,Y=-28,Z=55),NewHitPointType=NHP_GunOptics)
    NewVehHitpoints(1)=(PointRadius=20.0,PointBone="body",PointOffset=(X=50.0,Y=6.0,Z=38.0),NewHitPointType=NHP_Traverse)
    NewVehHitpoints(2)=(PointRadius=20.0,PointBone="body",PointOffset=(X=50.0,Y=6.0,Z=38.0),NewHitPointType=NHP_GunPitch)
    GunOpticsHitPointIndex=0
    TreadHitMaxHeight=15
    TreadDamageThreshold=0.5
    DamagedEffectScale=0.9
    DamagedEffectOffset=(X=-100.0,Y=20.0,Z=26.0)
    DestroyedVehicleMesh=StaticMesh'DH_German_vehicles_stc5.Stug3b.stug3b_destroyed'
    ...
    // HUD
    VehicleHudImage=Texture'DH_InterfaceArt_tex.Tank_Hud.stug3b_body'
    VehicleHudTurret=TexRotator'DH_InterfaceArt_tex.Tank_Hud.Stug3b_turret_rot'
    VehicleHudTurretLook=TexRotator'DH_InterfaceArt_tex.Tank_Hud.Stug3b_turret_look'
    ...
    Begin Object Class=SVehicleWheel Name=LF_Steering
        ...
        bLeftTrack=true
    End Object
    Wheels(0)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.LF_Steering'
    Begin Object Class=SVehicleWheel Name=RF_Steering
        ...
        WheelRadius=30.0
    End Object
    Wheels(1)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.RF_Steering'
    Begin Object Class=SVehicleWheel Name=LR_Steering
        ...
        bLeftTrack=true
    End Object
    Wheels(2)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.LR_Steering'
    Begin Object Class=SVehicleWheel Name=RR_Steering
        ...
        WheelRadius=30.0
    End Object
    Wheels(3)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.RR_Steering'
    Begin Object Class=SVehicleWheel Name=Left_Drive_Wheel
        ...
        bLeftTrack=true
    End Object
    Wheels(4)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.Left_Drive_Wheel'
    Begin Object Class=SVehicleWheel Name=Right_Drive_Wheel
        ...
        WheelRadius=30.0
    End Object
    Wheels(5)=SVehicleWheel'DH_Vehicles.DH_Stug3BDestroyer.Right_Drive_Wheel'
    ...
    End Object
    KParams=KarmaParamsRBFull'DH_Vehicles.DH_Stug3BDestroyer.KParams0'
}
