...
defaultproperties
{
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Stug3G_anm.Stuglate_turret_int')
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Stug3G_anm.Stuglate_turret_int')
    ...
    DriverPositions(5)=(PositionMesh=SkeletalMesh'DH_Stug3G_anm.Stuglate_turret_int')
