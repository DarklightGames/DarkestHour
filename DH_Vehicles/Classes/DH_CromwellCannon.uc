...
defaultproperties
{
    ...
    Skins(1)=Texture'DH_VehiclesUK_tex.Cromwell_body_int2'
    CollisionStaticMeshes(0)=(CollisionStaticMesh=StaticMesh'DH_allies_vehicles_stc.Cromwell_turret_Coll')
