...
//==============================================================================
 class DH_OpelBlitzPassengerSeven extends DH_ROPassengerPawn;
...
defaultproperties
{
     ...
     ExitPositions(0)=(X=-250.000000,Y=150.000000,Z=75.000000)
     ExitPositions(1)=(X=-250.000000,Y=100.000000,Z=75.000000)
     ExitPositions(2)=(X=-250.000000,Y=-100.000000,Z=75.000000)
     ExitPositions(3)=(X=-250.000000,Y=-150.000000,Z=75.000000)
