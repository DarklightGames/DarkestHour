...
defaultproperties
{
    ...
    GunClass=Class'DH_WirbelwindCannon'
    ...
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Flak38_anm.Wirbelwind_turret',TransitionUpAnim="lookover_up",TransitionDownAnim="optic_in",bExposed=true,DriverTransitionAnim="crouch_idle_binoc")
