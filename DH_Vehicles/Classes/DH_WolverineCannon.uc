...
defaultproperties
{
    ...
    Skins(0)=Texture'DH_VehiclesUS_tex.M10_turret_ext'
    Skins(1)=Texture'DH_VehiclesUS_tex.M10_turret_int'
    Skins(2)=Texture'DH_VehiclesUS_tex.M10_turret_int'
    ...
    // Cannon ammo
    PrimaryProjectileClass=Class'DH_WolverineCannonShell'
    SecondaryProjectileClass=Class'DH_WolverineCannonShellHVAP'
    TertiaryProjectileClass=Class'DH_WolverineCannonShellHE'
