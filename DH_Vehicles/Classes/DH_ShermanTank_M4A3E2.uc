...
class DH_ShermanTank_M4A3E2 extends DHTreadCraft;
...
defaultproperties
{
    ...
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_ShermanM4A3E2_anm.ShermanM4A3E2_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=5500,ViewNegativeYawLimit=-5500,ViewFOV=90.0,bDrawOverlays=true)
    ...
    DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_ShermanM4A3E2_anm.ShermanM4A3E2_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer4_driver_open",ViewPitchUpLimit=5000,ViewPitchDownLimit=62000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=true,ViewFOV=90.0)
