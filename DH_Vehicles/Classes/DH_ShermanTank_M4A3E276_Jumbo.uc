...
class DH_ShermanTank_M4A3E276_Jumbo extends DH_ShermanTank_M4A3E2_Jumbo;

defaultproperties
{
    VehicleNameString="M4A3E2(76)W Sherman"
    ReinforcementCost=8
    PassengerWeapons(0)=(WeaponPawnClass=class'DH_Vehicles.DH_ShermanCannonPawn_M4A3E276_Jumbo')
    VehicleMass=14.0
