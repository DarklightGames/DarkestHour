...
defaultproperties
{
    ...
    DriverPositions(1)=(ViewLocation=(X=-9.0,Y=-12.0,Z=0.0),PositionMesh=Mesh'DH_T60_anm.T60_turret_int',ViewPitchUpLimit=5000,ViewPitchDownLimit=65535,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-10000,bDrawOverlays=false,bExposed=false)
    DriverPositions(2)=(ViewLocation=(X=-9.0,Y=12.0,Z=0.0),PositionMesh=Mesh'DH_T60_anm.T60_turret_int',DriverTransitionAnim=VT60_com_close,TransitionUpAnim=com_open,ViewPitchUpLimit=5000,ViewPitchDownLimit=65535,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-10000,bDrawOverlays=false,bExposed=false)
