...
class DH_TwoInchBombThrower extends DHVehicleSmokeLauncher; // British Ordnance SBML 2-inch light mortar, mounted in vehicles as a smoke launcher

defaultproperties
{
    ProjectileClass=class'DH_Vehicles.DH_TwoInchMortarBombSmoke'
    InitialAmmo=20
    FireRotation(0)=(Pitch=8192) // assumed 45 degrees as can't find any references
    FireSound=SoundGroup'DH_WeaponSounds.Mortars.6cmFireSG' // TODO: probably better to have specific sound made, without mortar's 'plop' sound as round is dropped down tube
