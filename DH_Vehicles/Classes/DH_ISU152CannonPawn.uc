...
defaultproperties
{
    ...
    // TODO: periscope had choice of x1 and x5 magnification so could have 2 positions, but code currently only handles one PeriscopePositionIndex so have gone with x5
    // Could easily alter functionality to handle both
    DriverPositions(1)=(ViewFOV=18.0,ViewLocation=(X=15.0,Z=11.0),PositionMesh=SkeletalMesh'DH_ISU152_anm.ISU152-turret_int',TransitionUpAnim="com_open",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-6000,bDrawOverlays=true)
    ...
    DestroyedGunsightOverlay=texture'DH_VehicleOpticsDestroyed_tex.Allied.Sherman_sight_destroyed' // TODO: use/make one for ISU152/Soviets
