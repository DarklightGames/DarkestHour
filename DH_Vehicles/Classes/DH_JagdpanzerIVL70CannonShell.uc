...
//==============================================================================
class DH_JagdpanzerIVL70CannonShell extends DH_GermanTankCannonShell;
...
defaultproperties
{
     ...
     DHPenetrationTable(0)=18.299999
     DHPenetrationTable(1)=17.900000
     DHPenetrationTable(2)=16.799999
     DHPenetrationTable(3)=15.800000
     DHPenetrationTable(4)=14.900000
     DHPenetrationTable(5)=14.000000
     DHPenetrationTable(6)=13.200000
     DHPenetrationTable(7)=12.500000
     DHPenetrationTable(8)=11.600000
     DHPenetrationTable(9)=10.300000
     DHPenetrationTable(10)=9.100000
