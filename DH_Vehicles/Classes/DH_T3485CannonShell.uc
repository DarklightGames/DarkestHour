...
defaultproperties
{
    ...
    MechanicalRanges(11)=(Range=1800,RangeValue=198.0)
    MechanicalRanges(12)=(Range=2000,RangeValue=224.0)
    MechanicalRanges(13)=(Range=2200,RangeValue=253.0)
    MechanicalRanges(14)=(Range=2400,RangeValue=287.0)
    MechanicalRanges(15)=(Range=2600,RangeValue=324.0)
    MechanicalRanges(16)=(Range=2800,RangeValue=362.0)
    MechanicalRanges(17)=(Range=3000,RangeValue=399.0)
    MechanicalRanges(18)=(Range=3200,RangeValue=445.0)
    MechanicalRanges(19)=(Range=3400,RangeValue=491.0)
    MechanicalRanges(20)=(Range=3600,RangeValue=536.0)
    MechanicalRanges(21)=(Range=3800,RangeValue=588.0)
