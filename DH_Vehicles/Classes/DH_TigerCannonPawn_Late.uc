...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewLocation=(X=35.0,Y=-31.0,Z=3.0),ViewFOV=17.0,ViewPitchUpLimit=3095,ViewPitchDownLimit=64353,ViewPositiveYawLimit=19000,ViewNegativeYawLimit=-20000,bDrawOverlays=true)
    DriverPositions(1)=(ViewLocation=(X=35.0,Y=-31.0,Z=3.0),ViewFOV=34.0,TransitionUpAnim="",DriverTransitionAnim="",ViewPitchUpLimit=3095,ViewPitchDownLimit=64353,ViewPositiveYawLimit=19000,ViewNegativeYawLimit=-20000,bDrawOverlays=true)
