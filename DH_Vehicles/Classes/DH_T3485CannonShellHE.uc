...
defaultproperties
{
    ...
    bOpticalAiming=true // just a visual range indicator on the side; doesn't actually alter the aiming point // TODO: different from AP shell?
    ...
    OpticalRanges(21)=(Range=4200,RangeValue=0.813) // TODO: range indicator doesn't move above 4000?
