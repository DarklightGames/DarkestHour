...
defaultproperties
{
    ...
    RightArmor(1)=(Thickness=3.0,Slope=10.0,MaxRelativeHeight=27.0,LocationName="lower_super")
    ...
    LeftArmor(1)=(Thickness=3.0,Slope=10.0,MaxRelativeHeight=27.0,LocationName="lower_super")
