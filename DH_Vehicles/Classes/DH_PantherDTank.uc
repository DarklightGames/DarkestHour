...
defaultproperties
{
    ...
    VehHitpoints(0)=(PointRadius=10.0,PointBone="body",PointOffset=(X=100.0,Y=-30.0,Z=61.0))
    VehHitpoints(1)=(PointRadius=32.0,PointHeight=35.0,PointOffset=(X=-90.0,Z=6.0))
