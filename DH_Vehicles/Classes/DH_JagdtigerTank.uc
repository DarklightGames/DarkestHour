...
//
// German Jagdtiger - Jagdpanzer VI Ausf.B (SdKfz 186)
//===================================================================
class DH_JagdtigerTank extends DH_ROTreadCraftB;
...
defaultproperties
{
     ...
     ExhaustPipes(0)=(ExhaustPosition=(X=-252.000000,Y=24.000000,Z=30.000000),ExhaustRotation=(Pitch=22000))
     ExhaustPipes(1)=(ExhaustPosition=(X=-252.000000,Y=-28.000000,Z=30.000000),ExhaustRotation=(Pitch=22000))
     ...
     DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_Jagdtiger_anm.jagdtiger_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-6000,ViewFOV=80.000000,bDrawOverlays=True)
     DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_Jagdtiger_anm.jagdtiger_body_int',TransitionUpAnim="driver_hatch_open",TransitionDownAnim="Overlay_In",DriverTransitionAnim="VPanther_driver_close",ViewPitchUpLimit=4000,ViewPitchDownLimit=63500,ViewPositiveYawLimit=8000,ViewNegativeYawLimit=-8000,ViewFOV=80.000000)
     DriverPositions(2)=(PositionMesh=SkeletalMesh'DH_Jagdtiger_anm.jagdtiger_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanther_driver_open",ViewPitchUpLimit=6000,ViewPitchDownLimit=65000,ViewPositiveYawLimit=16000,ViewNegativeYawLimit=-16000,bExposed=True,ViewFOV=80.000000)
     ...
     VehHitpoints(0)=(PointOffset=(X=8.000000,Z=7.000000),bPenetrationPoint=False)
     VehHitpoints(1)=(PointRadius=40.000000,PointOffset=(X=-150.000000,Z=-20.000000),DamageMultiplier=1.000000)
     VehHitpoints(2)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(X=-55.000000,Y=-65.000000,Z=4.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(3)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(X=-55.000000,Y=65.000000,Z=4.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(4)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(Y=-65.000000,Z=4.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
     VehHitpoints(5)=(PointRadius=15.000000,PointScale=1.000000,PointBone="body",PointOffset=(Y=65.000000,Z=4.000000),DamageMultiplier=5.000000,HitPointType=HP_AmmoStore)
