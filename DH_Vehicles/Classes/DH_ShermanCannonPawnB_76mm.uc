...
defaultproperties
{
    DriverPositions(0)=(PositionMesh=SkeletalMesh'DH_ShermanM4A1_anm.Sherman76mm_turret_extB')
    DriverPositions(1)=(PositionMesh=SkeletalMesh'DH_ShermanM4A1_anm.Sherman76mm_turret_extB')
