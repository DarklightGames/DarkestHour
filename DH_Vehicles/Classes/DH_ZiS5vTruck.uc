...
defaultproperties
{
    ...
    EngineHealth=30
    VehHitpoints(0)=(PointRadius=25.0,PointScale=1.0,PointBone="Body",PointOffset=(X=100.0,Y=0.0,Z=11.0),bPenetrationPoint=false,DamageMultiplier=1.0,HitPointType=HP_Engine) // engine
