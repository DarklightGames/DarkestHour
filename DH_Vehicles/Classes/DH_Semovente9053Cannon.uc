...
defaultproperties
{
    ...
    VehicleAttachments(1)=(AttachClass=class'DH_Engine.DHRadio',RelativeLocation=(X=-42.1971,Y=-54.814,Z=37.2554),RadioCollisionRadius=16.0,RadioCollisionHeight=10.0)
