...
class DH_StuH42Destroyer extends DHArmoredVehicle;
...
defaultproperties
{
    ...
    VehHitpoints(0)=(PointRadius=2.0,PointOffset=(X=-15.0,Z=-22.0))
    VehHitpoints(1)=(PointRadius=20.0,PointHeight=25.0,PointOffset=(X=-90.0))
