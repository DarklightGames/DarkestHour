...
defaultproperties
{
    ...
    Skins(0)=Texture'DH_Weapon_tex.30calMain'
    Skins(1)=Texture'DH_Weapon_tex.30calGrip'
    Skins(2)=Texture'DH_Weapon_tex.30CalAmmoTin'
    Skins(3)=Texture'DH_VehiclesUS_tex.Green'
