...
defaultproperties
{
    ...
    DriverPositions(0)=(ViewFOV=60.0,PositionMesh=SkeletalMesh'DH_M7Priest_anm.ext_mg',TransitionUpAnim="com_open",ViewPitchUpLimit=5000,ViewPitchDownLimit=63000,bDrawOverlays=true,bExposed=true)
