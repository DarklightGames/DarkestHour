...
class DH_KV1sCannonPawn_Late extends DHSovietCannonPawn;
...
defaultproperties
{
    ...
    //
    DriverPositions(2)=(ViewFOV=72.0,PositionMesh=SkeletalMesh'DH_KV_anm.KV1S_turret_int',TransitionUpAnim="com_open",DriverTransitionAnim="VKV1_com_close",ViewPitchUpLimit=5000,ViewPitchDownLimit=65000,ViewPositiveYawLimit=6000,ViewNegativeYawLimit=-10000)
