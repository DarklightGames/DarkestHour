...
defaultproperties
{
    ...
    Constructions(11)=(ConstructionClass=Class'DH_MG42LafetteGunConstruction',Limit=3,MaxActive=-1)
    Constructions(12)=(ConstructionClass=Class'DH_Granatwerfer34MortarConstruction',Limit=3,MaxActive=-1)
    Constructions(13)=(ConstructionClass=Class'DH_Pak36ATGunConstruction',Limit=3,MaxActive=-1)
