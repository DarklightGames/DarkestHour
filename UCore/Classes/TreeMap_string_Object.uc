...
var private TreeMapNode_string_Object Head;
...
private function GetKeysTraverse(TreeMapNode_string_Object Node)
{
    if (Node == none)
    {
        return;
...
private function GetValuesTraverse(TreeMapNode_string_Object Node)
{
    if (Node == none)
    {
        return;
...
{
    local TreeMapNode_string_Object Node;
...
private static function int GetBalance(TreeMapNode_string_Object Node)
{
    if (Node == none)
    {
        return 0;
...
private static function int GetHeight(TreeMapNode_string_Object Node)
{
    if (Node == none)
    {
        return 0;
...
private static function TreeMapNode_string_Object FindMin(TreeMapNode_string_Object Node)
{
    while (Node.LHS != none)
    {
        Node = Node.LHS;
...
private static function TreeMapNode_string_Object EraseStatic(TreeMap_string_Object D, TreeMapNode_string_Object Node)
{
    local int Balance;
    local TreeMapNode_string_Object Temp;
...
private static function TreeMapNode_string_Object RotateRight(TreeMapNode_string_Object Y)
{
    local TreeMapNode_string_Object X;
    local TreeMapNode_string_Object T2;
...
private static function TreeMapNode_string_Object RotateLeft(TreeMapNode_string_Object X)
{
    local TreeMapNode_string_Object Y;
    local TreeMapNode_string_Object T2;
...
private static function TreeMapNode_string_Object PutStatic(TreeMap_string_Object D, TreeMapNode_string_Object Node)
{
    local int Balance;

    if (Node == none)
    {
        Node = new class'TreeMapNode_string_Object';
