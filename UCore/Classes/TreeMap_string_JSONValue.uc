...
class TreeMap_string_JSONValue extends Object;

var private TreeMapNode_string_JSONValue Head;
var private array<string> Keys;
var private array<JSONValue> Values;
var private int Size;
var private string RecursiveKey;
var private JSONValue RecursiveValue;
...
private function GetKeysTraverse(TreeMapNode_string_JSONValue Node)
{
    if (Node == none)
    {
        return;
...
function array<JSONValue> GetValues()
{
    Values.Length = 0;
...
private function GetValuesTraverse(TreeMapNode_string_JSONValue Node)
{
    if (Node == none)
    {
        return;
...
function bool Get(string Key, optional out JSONValue Value)
{
    local TreeMapNode_string_JSONValue Node;
...
private static function int GetBalance(TreeMapNode_string_JSONValue Node)
{
    if (Node == none)
    {
        return 0;
...
private static function int GetHeight(TreeMapNode_string_JSONValue Node)
{
    if (Node == none)
    {
        return 0;
...
private static function TreeMapNode_string_JSONValue FindMin(TreeMapNode_string_JSONValue Node)
{
    while (Node.LHS != none)
    {
        Node = Node.LHS;
...
private static function TreeMapNode_string_JSONValue EraseStatic(TreeMap_string_JSONValue D, TreeMapNode_string_JSONValue Node)
{
    local int Balance;
    local TreeMapNode_string_JSONValue Temp;
...
private static function TreeMapNode_string_JSONValue RotateRight(TreeMapNode_string_JSONValue Y)
{
    local TreeMapNode_string_JSONValue X;
    local TreeMapNode_string_JSONValue T2;
...
private static function TreeMapNode_string_JSONValue RotateLeft(TreeMapNode_string_JSONValue X)
{
    local TreeMapNode_string_JSONValue Y;
    local TreeMapNode_string_JSONValue T2;
...
private static function TreeMapNode_string_JSONValue PutStatic(TreeMap_string_JSONValue D, TreeMapNode_string_JSONValue Node)
{
    local int Balance;
