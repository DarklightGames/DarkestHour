...
class DH_ROGESquadLeaderGreatH extends DH_ROGE_Heer_Greatcoat;
...
defaultproperties
{
    ...
    PrimaryWeapons(1)=(Item=class'DH_ROWeapons.DH_MP41Weapon',Amount=6,AssociatedAttachment=class'ROInventory.ROMP40AmmoPouch')
