class DHMuzzleFlash3rdBAR extends ROMuzzleFlash3rd;

//Special muzzle effect class for BAR due to misalignment of 'tip' bone
...
defaultproperties
{
   Begin Object Class=SpriteEmitter Name=SpriteEmitter0
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter1
        FadeOut=true
        BeamDistanceRange=(Min=100.000000,Max=150.000000)
        ...
        MaxParticles=1
        name="spike_smoke"
        StartLocationOffset=(X=-5.0,Y=0.9,Z=1.25)
        UseRotationFrom=PTRS_Actor
        SizeScale(0)=(RelativeSize=0.1)
        SizeScale(1)=(RelativeTime=0.140000,RelativeSize=1.000000)
        SizeScale(2)=(RelativeTime=1.000000,RelativeSize=2.5000000)
        StartSizeRange=(X=(Min=4.000000,Max=8.000000),Y=(Min=4.000000,Max=8.000000),Z=(Min=100.000000))
