...
defaultproperties
{
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter1
        ...
        Sounds(0)=(Sound=SoundGroup'ProjectileSounds.cannon_rounds.AP_Impact_Water',Radius=(Min=256.0,Max=312.0),Pitch=(Min=1.0,Max=1.4),Volume=(Min=0.7,Max=0.9),Probability=(Min=1.0,Max=1.0))
