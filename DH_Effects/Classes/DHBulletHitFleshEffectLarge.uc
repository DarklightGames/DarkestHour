...
defaultproperties
{
    ...
    Begin Object Class=MeshEmitter Name=MeshEmitter0
        ...
        StartSizeRange=(X=(Min=0.350000,Max=1.000000),Y=(Min=0.3500000,Max=1.000000),Z=(Min=0.3500000,Max=1.000000))
        InitialParticlesPerSecond=2000.000000
        LifetimeRange=(Min=2.500000,Max=3.500000)
        StartVelocityRange=(X=(Min=-75.000000,Max=150.000000),Y=(Min=-450.000000,Max=400.000000),Z=(Min=-100.000000,Max=125.000000))
        VelocityLossRange=(Z=(Min=0.75,Max=1.000000))
    End Object
