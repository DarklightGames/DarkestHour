...
class DHMolotovCoctailTrail extends Emitter;
...
defaultproperties
{
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter0
        ...
        SphereRadiusRange = (Max=2.0)
        StartSpinRange=(X=(Min=-0.1,Max=0.1))
        StartSizeRange=(X=(Min=3.0,Max=16.0),Y=(Min=0.0,Max=0.0),Z=(Min=0.0,Max=0.0))
    ...
    Begin Object Class=SparkEmitter Name=SparkEmitter0
        ...
        LifetimeRange=(Max=2.0)
        StartVelocityRange=(X=(Min=-30,Max=30),Y=(Min=-30,Max=30),Z=(Min=60.0,Max=300))
    End Object
