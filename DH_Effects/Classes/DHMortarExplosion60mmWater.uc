...
class DHMortarExplosion60mmWater extends Emitter;
...
defaultproperties
{
    ...
    End Object
    Emitters(6)=SpriteEmitter'SpriteEmitter20'
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter5
        ...
        StartVelocityRange=(X=(Min=-100.000000,Max=100.000000),Y=(Min=-100.000000,Max=100.000000),Z=(Min=150.000000,Max=225.000000))
    End Object
    ...
    End Object
    Emitters(9)=SpriteEmitter'SpriteEmitter30'
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter7
        ...
        StartLocationOffset=(Z=-50.000000)
        SizeScale(0)=(RelativeSize=1.000000)
        SizeScale(1)=(RelativeTime=0.500000,RelativeSize=2.00000)
        SizeScale(2)=(RelativeTime=1.000000,RelativeSize=4.00000)
        StartSizeRange=(Z=(Min=250.000000,Max=300.000000))
        InitialParticlesPerSecond=50.000000
        DrawStyle=PTDS_AlphaBlend
        Texture=Texture'DH_FX_Tex.Effects.Impact01'
        LifetimeRange=(Min=2.500000,Max=3.000000)
        InitialDelayRange=(Min=0.350000,Max=0.500000)
        StartVelocityRange=(X=(Min=-50.000000,Max=50.000000),Y=(Min=-50.000000,Max=50.000000),Z=(Min=400.000000,Max=450.000000))
    End Object
    Emitters(10)=BeamEmitter'BeamEmitter7'
}
