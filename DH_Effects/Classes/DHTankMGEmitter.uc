...
//General muzzle flash effect class for all DH tank co-ax mg's

class DHTankMGEmitter extends WeaponAmbientEmitter;
...
simulated function SetEmitterStatus(bool bEnabled)
{
    if(bEnabled)
    {
        ...
        Emitters[2].ParticlesPerSecond = 8.33;
        Emitters[2].InitialParticlesPerSecond = 8.33;
        Emitters[2].AllParticlesDead = false;
        Emitters[3].ParticlesPerSecond = 25.0;
        Emitters[3].InitialParticlesPerSecond = 25.0;
