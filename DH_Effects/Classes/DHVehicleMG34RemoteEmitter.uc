...
class DHVehicleMG34RemoteEmitter extends WeaponAmbientEmitter;
...
simulated function SetEmitterStatus(bool bEnabled)
{
    ...
    {
        //850 rpm
        Emitters[0].ParticlesPerSecond = 14.2;
        Emitters[0].InitialParticlesPerSecond = 14.2;
        ...
        Emitters[2].ParticlesPerSecond = 14.2;
        Emitters[2].InitialParticlesPerSecond = 14.2;
...
defaultproperties
{
    Begin Object Class=MeshEmitter Name=MeshEmitter0
        ...
        MaxParticles=30
        StartLocationOffset=(X=-38.000000,Y=1.000000,Z=2.0)
