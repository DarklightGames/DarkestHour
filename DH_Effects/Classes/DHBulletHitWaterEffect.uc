...
defaultproperties
{
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter0
        ...
        MaxParticles=1
        UseRotationFrom=PTRS_Actor
        StartSizeRange=(X=(Min=10.000000,Max=15.000000),Y=(Min=10.000000,Max=15.000000),Z=(Min=25.000000,Max=50.000000))
        InitialParticlesPerSecond=50.000000
        DrawStyle=PTDS_AlphaBlend
        Texture=Texture'DH_FX_Tex.Effects.WaterImpact01'
        LifetimeRange=(Min=0.50000,Max=0.750000)
        StartVelocityRange=(X=(Min=300.000000,Max=500.000000),Y=(Min=-75.000000,Max=75.000000),Z=(Min=-75.000000,Max=75.000000))
    End Object
    Emitters(7)=BeamEmitter'BeamEmitter0'
