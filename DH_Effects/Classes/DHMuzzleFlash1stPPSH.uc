...
class DHMuzzleFlash1stPPSH extends ROMuzzleFlash1st;
...
simulated function Trigger(Actor Other, Pawn EventInstigator)
{
    ...
    else
    {
        ...
        Emitters[3].SpawnParticle(1);
        Emitters[3].UseColorScale=false;
    } 
}
...
{   
    Begin Object Class=SpriteEmitter Name=SpriteEmitter38
        ...
        Texture=Texture'DH_FX_Tex.Weapons.ppshmuzzleflash_1frame'
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter14 
        ...
        Opacity=0.25
        UseRotationFrom=PTRS_Actor
        StartSizeRange=(X=(Min=2.000000,Max=4.000000),Y=(Min=2.000000,Max=4.000000),Z=(Min=80.000000,Max=100.000000))
        DrawStyle=PTDS_Brighten
